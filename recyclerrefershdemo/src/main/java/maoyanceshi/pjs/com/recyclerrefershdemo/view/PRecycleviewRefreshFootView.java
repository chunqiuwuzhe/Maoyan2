...
import maoyanceshi.pjs.com.recyclerrefershdemo.R;


/**
 * Created by yukuo on 2016/4/30.
 */
public class PRecycleviewRefreshFootView extends LinearLayout {
    ...
    public PRecycleviewRefreshFootView(Context context) {
        super(context);
        initView(context);
    }

    public PRecycleviewRefreshFootView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
