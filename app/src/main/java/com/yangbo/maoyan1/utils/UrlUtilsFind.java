...
public class UrlUtilsFind {
    ...
    // 电影详情界面  需要替换id
    public static final String  URL_MOVIE_H5 = "http://m.maoyan.com/movie/";
    //要用targetId 替换 12498
    public static final String  URL_FIND_LIST_H5 ="http://m.maoyan.com/information/12498?_v_=yes";
