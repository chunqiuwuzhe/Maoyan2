...
public class UrlUtils {
    ...
    public static final String URL_REYING_VIEWPAGER="http://advert.mobile.meituan." +
            "com/api/v3/adverts?cityid=1&category=11&version=6.8.0&" +
            "new=0&app=movie&clienttp=android&uuid=" +
            "FCFAB9D8DD339645D629C8372A29A2C6AD16F9C9E87AF9AC0D656B29DD5AC6DE&" +
            "devid=866641027400542&uid=&movieid=&partner=1&apptype=1&smId=&utm_" +
            "campaign=AmovieBmovieCD-1&movieBundleVersion=6801&utm_source=qq&utm_medium" +
            "=android&utm_term=6.8.0&utm_content=866641027400542&ci" +
            "=1&net=255&dModel=HM%20NOTE%201LTETD&lat=40.100855&lng" +
