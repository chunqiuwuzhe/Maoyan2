 ...
 */
public class FullLinearLayou extends LinearLayoutManager {

    private int[] mMeasuredDimension = new int[2];
    int dividerHeight = 1;//分割线高度，默认为1,这里的分割线高度和fullLinearlayoutmanager的分割线高度必须一致！

    @SuppressWarnings("UnusedDeclaration")
    public FullLinearLayou(Context context, int dividerHeight) {
        super(context);
        this.dividerHeight = dividerHeight;
    }

    @SuppressWarnings("UnusedDeclaration")
    public FullLinearLayou(Context context, int orientation, boolean reverseLayout) {
